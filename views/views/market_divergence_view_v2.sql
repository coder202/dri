-- Add index suggestions for better performance
-- CREATE INDEX idx_signals_event_ts_tag ON signals(event_ts, tag);
-- CREATE INDEX idx_signals_source ON signals(signal_source);

-- Consider adding signal count for confidence weighting
